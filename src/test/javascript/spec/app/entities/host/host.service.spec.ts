...
describe('Service Tests', () => {
    describe('Host Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(HostService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/hosts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Host', () => {
                service.create(new Host(null)).subscribe(received => {
            ...
            it('should update a Host', () => {
                service.update(new Host(123)).subscribe(received => {
